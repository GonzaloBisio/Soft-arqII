...
type imageServiceInterface interface {
	GetImageById(id int)
	GetImagesByHotelId(hotelID int)
	GetImages()
	InsertImage(hotelID int, imageFile *multipart.FileHeader)
	DeleteImageById(id int)
}
...
func (s *imageService) GetImageById(id int) {

}
func (s *imageService) GetImagesByHotelId(hotelID int) {
...
func (s *imageService) DeleteImageById(id int) {

}

func (s *imageService) InsertImage(hotelID int, imageFile *multipart.FileHeader) {
